...
public interface QuestionRepository extends JpaRepository<Question, Long> {
	...
	@Query("""
			SELECT q.mockTest.id, q.topic FROM Question q
			WHERE q.mockTest.id IN :mockIds AND q.topic IS NOT NULL
			""")
	List<Object[]> findTopicPairsByMockIds(@Param("mockIds") Collection<Long> mockIds);
}
